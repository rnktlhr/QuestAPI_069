...
fun DetailSiswaScreen(
    ...
    Scaffold(
        ...
        floatingActionButton = {
            ...
            // FloatingActionButton hanya aktif jika data berhasil dimuat (Success)
    ...
    Column(
        ...
        when (statusUIDetail) {
            ...
            is StatusUIDetail.Error -> {
                Box(modifier = Modifier.fillMaxWidth(), contentAlignment = Alignment.Center) {
                    Text(text = "Gagal memuat data siswa. Pastikan koneksi internet stabil.", color = MaterialTheme.colorScheme.error)
                }
            }
        }
